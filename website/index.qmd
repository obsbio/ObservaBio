...
<header class="hero">
  ...
  <div class="wrap hero-head" id="conteudo">
    ...
    <div class="hero-actions">
      <!-- PUBLICAÇÃO — LIGAR O BOTÃO PRINCIPAL
           O app ainda não tem endereço. Enquanto não tiver, isto é um controle
           desabilitado de verdade: não recebe foco e não responde ao clique. Um
           <a href="#"> continuaria clicável e rolaria a página para o topo, o
           que é pior do que não fazer nada.

           Quando a publicação no Connect Cloud existir, troque a linha marcada
           CTA-APP logo abaixo por esta, com a URL no lugar:

               <a class="btn btn-primary" href="https://SUA-URL">Abrir o ObservaBio</a>

           depois apague o <p class="hero-note"> e rode `quarto render` dentro
           de website/. Passo a passo completo em docs/manutencao.md. -->
      <!-- CTA-APP -->
      <button class="btn btn-primary" type="button" disabled>Abrir o ObservaBio</button>
      <a class="btn btn-ghost" href="#distribuicao">Ver como funciona</a>
    </div>
    <p class="hero-note">O ObservaBio ainda não está no ar. Assim que a publicação for concluída, este botão abre o app.</p>
  </div>
  ...
  <div class="wrap">
    ...
    <div class="outputs">
      <article class="output">
        ...
        <p>
          A sua planilha em Darwin Core, com os nomes aceitos, os autores, a
          classificação e o status de conservação preenchidos. É esse arquivo que
          segue para o SiBBr, para o GBIF ou para o relatório.
        </p>
      </article>
      <article class="output">
        <h3>Auditoria</h3>
...
<footer class="site-footer">
  <div class="wrap footer-grid">
    <div class="footer-brand">
      ...
      <p class="footer-tag">Padronização e validação Darwin Core</p>
    </div>
  ...
  <!-- Crédito institucional. O wordmark do Observatório já vem em marfim
