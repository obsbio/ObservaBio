...
<header class="hero">
  ...
  <div class="wrap hero-head" id="conteudo">
    ...
    <div class="hero-actions">
      <!-- Sem destino ainda, então o botão é um controle desabilitado de
           verdade: não recebe foco e não responde ao clique. Um <a href="#">
           continuaria clicável e só rolaria a página para o topo.
           TODO: trocar por <a class="btn btn-primary" href="URL"> quando a
           publicação for definida. -->
    ...
    <p class="hero-note">O endereço do app entra aqui assim que a publicação for definida.</p>
  </div>
